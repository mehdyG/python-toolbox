...
#this block was replaced with the next block.
    ...
    #    main_file=main_file
#This Block
    # Do not rebase main_file yet; we'll work with the templateDir version first
    ...
    main_file = os.path.join(wd, main_file) ##Added by Mehdy
    ...
    for ip,(wd,p) in enumerate(zip(workDirS,PARAMS)):
        ...
        main_file = os.path.join(wd, os.path.basename(main_file)) ## Added by Mehdy
