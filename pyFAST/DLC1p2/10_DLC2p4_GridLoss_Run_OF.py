...
def main():
    ...
    URefs = [5, 7, 9, 11, 13, 15, 17, 19, 21]    #[np.arange(3, 26, 2)]   V_cutin = 3 m/s to V_cut_out 0 25 m/s [3,5,...,25]
    seeds = [1, 2, 3, 4, 5, 6]                      #Different random seeds für DLC 2.4 
